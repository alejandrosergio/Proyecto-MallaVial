...
function Header()
{
    ...
    $this->Cell(80);
    // Título 
    $this->Cell(30,25,'FACTURA ORDEN DE MANTENIMIENTO',0,0,'C');
    // Salto de línea
    $this->Ln(25);
...
$pdf->SetY(50);
$pdf->Cell(190,14,utf8_decode('INFORMACIÓN ORDEN DE MANTENIMIENTO'),0,0,'C');
//----------------------------------------------------------------------------
//INFORMACIÓN ORDEN DE MANTENIMIENTO
$pdf->Rect(10,70,190,25,'F');
$pdf->SetXY(20,75);
$pdf->cell(20,5,utf8_decode("Orden N°:"),0,0);

$pdf->SetXY(80,75);
$pdf->cell(20,5,utf8_decode("Prioridad:"),0,0);

$pdf->SetXY(140,75);
$pdf->cell(20,5,utf8_decode("Fecha Inicio:"),0,0);

$pdf->SetXY(20,90);
$pdf->cell(20,5,utf8_decode("Lugar de ejecución:"),0,0);
//-----------------------------------------------------------------------------
